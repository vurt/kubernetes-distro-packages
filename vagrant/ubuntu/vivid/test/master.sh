...
echo `dpkg -i /kubernetes/etcd/builds/systemd/etcd_2.0.11_amd64.deb`
...
sleep 1
echo `dpkg -i /kubernetes/kubernetes/builds/systemd/kubernetes-master_"$K8S_VERSION"_amd64.deb`
